...
let s=n.combine()
V&&V.add(s)
return H(this).updatableTagFor(e).inner.update(s),r},set:s?function(){q.inner.dirty(),H(this).updatableTagFor(e).inner.update(g.create()),s.apply(this,arguments)}:void 0}}(e,n,r);(function(t,e){let n=Symbol(e)
H(t).trackedProperties[e]=!0,Object.defineProperty(t,e,{configurable:!0,get(){return L(this,e),this[n]},set(t){q.inner.dirty(),H(this).updatableTagFor(e).inner.update(g.create()),this[n]=t,J()}})})(e,n)}let V=null
...
let qt="undefined"==typeof document?null:document
class Jt{constructor(t){this.document=t,this.setupUselessElement()}setupUselessElement(){this.uselessElement=this.document.createElement("div")}createElement(t,e){let n,r
...
return new Ft(s,l,i)}(this.uselessElement,t,e,n)}createTextNode(t){return this.document.createTextNode(t)}createComment(t){return this.document.createComment(t)}}var Wt;(function(t){class e extends Jt{createElementNS(t,e){return this.document.createElementNS(t,e)}setAttribute(t,e,n,r=null){r?t.setAttributeNS(r,e,n):t.setAttribute(e,n)}}t.TreeConstruction=e
let n=e
n=jt(qt,n),n=Lt(qt,n,$t),t.DOMTreeConstruction=n})(Wt||(Wt={}))
let Kt=class extends Jt{constructor(t){super(t),this.document=t,this.namespace=null}setAttribute(t,e,n){t.setAttribute(e,n)}removeAttribute(t,e){t.removeAttribute(e)}insertAfter(t,e,n){this.insertBefore(t,e,n.nextSibling)}}
Kt=jt(qt,Kt),Kt=Lt(qt,Kt,$t)
...
e=i}}get offset(){let t=this.inner,e=this.args,n=e?e.positional.length:0
return je(t)?n+t.offset:n}}function He(t){return Ue(t)?"":String(t)}function Ue(t){return null==t||"function"!=typeof t.toString}function qe(t){return"object"==typeof t&&null!==t&&"function"==typeof t.toHTML}function Je(t){return"object"==typeof t&&null!==t&&"number"==typeof t.nodeType}function We(t){return"string"==typeof t}class Ke extends Te{constructor(t,e,n){super(),this.node=t,this.reference=e,this.lastValue=n,this.type="dynamic-text",this.tag=e.tag,this.lastRevision=this.tag.value()}evaluate(){let t=this.reference,e=this.tag
e.validate(this.lastRevision)||(this.lastRevision=e.value(),this.update(t.value()))}update(t){let e,n=this.lastValue
...
return function(t){return We(t)||Ue(t)||"boolean"==typeof t||"number"==typeof t}(t)?1:(e=t)&&e[Le]?0:qe(t)?3:function(t){return Je(t)&&11===t.nodeType}(t)?4:Je(t)?5:1
...
i in t?(n="prop",r=i):(n="attr",r=e)}return"prop"!==n||"style"!==r.toLowerCase()&&!function(t,e){let n=qn[t.toUpperCase()]
return n&&n[e.toLowerCase()]||!1}(t.tagName,r)||(n="attr"),{normalized:r,type:n}}const qn={INPUT:{form:!0,autocorrect:!0,list:!0},SELECT:{form:!0},OPTION:{form:!0},TEXTAREA:{form:!0},LABEL:{form:!0},FIELDSET:{form:!0},LEGEND:{form:!0},OBJECT:{form:!0},BUTTON:{form:!0}}
function Jn(t,e,n){let r=t.tagName,i={element:t,name:e,namespace:n}
...
return this.resolve(n)}registerHelper(t,e){return this.register("helper",t,(t,n)=>new qr(e,n))}registerInternalHelper(t,e){this.register("helper",t,e)}registerComponent(t,e,n,r){let i=this.registerTemplate(e,r),s=this.managerFor(i.meta.managerId),o=new X(t,s,n,i.handle)
...
return e}function qi(t,e){if(!e)throw new Error("Assertion Failed: "+t)}class Ji{constructor(t,e){this.config=t,this.registry=e}identify(t,e){if(function(t){let e=t.split(":"),n=e[0],r=e[1]
return!!(n&&r&&0===r.indexOf("/")&&r.split("/").length>3)}(t))return t
let n,r=Ui(t)
if(e){let t=Ui(e)
if($i(t)){qi("Specifier must not include a rootName, collection, or namespace when combined with an absolute referrer",void 0===r.rootName&&void 0===r.collection&&void 0===r.namespace),r.rootName=t.rootName,r.collection=t.collection
...
return qi(`'${t}' is not a recognized type`,e),e.definitiveCollection}_serializeAndVerify(t){let e=Hi(t)
...
i=s.default}n[r]=i}return n}function q(t){var e=Object.create(null)
...
var J=function(t,e,n){this.name=t,this.schema=e,this.spec=n,this.groups=n.group?n.group.split(" "):[],this.attrs=q(n.attrs),this.defaultAttrs=H(this.attrs),this.contentMatch=null,this.markSet=null,this.inlineContent=null,this.isBlock=!(n.inline||"text"==t),this.isText="text"==t},W={isInline:{},isTextblock:{},isLeaf:{},isAtom:{}}
...
return new T(this,this.computeAttrs(t),i.from(e),c.setFrom(n))},J.prototype.createChecked=function(t,e,n){if(e=i.from(e),!this.validContent(e))throw new RangeError("Invalid content for node "+this.name)
return new T(this,this.computeAttrs(t),e,c.setFrom(n))},J.prototype.createAndFill=function(t,e,n){if(t=this.computeAttrs(t),(e=i.from(e)).size){var r=this.contentMatch.fillBefore(e)
if(!r)return null
e=r.append(e)}var s=this.contentMatch.matchFragment(e).fillBefore(i.empty,!0)
return s?new T(this,t,e.append(s),c.setFrom(n)):null},J.prototype.validContent=function(t){var e=this.contentMatch.matchFragment(t)
if(!e||!e.validEnd)return!1
for(var n=0;n<t.childCount;n++)if(!this.allowsMarks(t.child(n).marks))return!1
return!0},J.prototype.allowsMarkType=function(t){return null==this.markSet||this.markSet.indexOf(t)>-1},J.prototype.allowsMarks=function(t){if(null==this.markSet)return!0
for(var e=0;e<t.length;e++)if(!this.allowsMarkType(t[e].type))return!1
return!0},J.prototype.allowedMarks=function(t){var e
if(null==this.markSet)return t
for(var n=0;n<t.length;n++)this.allowsMarkType(t[n].type)?e&&e.push(t[n]):e||(e=t.slice(0,n))
return e?e.length?e:c.empty:t},J.compile=function(t,e){var n=Object.create(null)
t.forEach(function(t,r){return n[t]=new J(t,e,r)})
...
return n},Object.defineProperties(J.prototype,W)
...
var Y=function(t,e,n,r){this.name=t,this.schema=n,this.spec=r,this.attrs=q(r.attrs),this.rank=e,this.excluded=null
var i=H(this.attrs)
...
this.spec.nodes=r.from(t.nodes),this.spec.marks=r.from(t.marks),this.nodes=J.compile(this.spec.nodes,this),this.marks=Y.compile(this.spec.marks,this)
...
else{if(!(t instanceof J))throw new RangeError("Invalid node type: "+t)
...
return e.text||(e.text=function(t){return t.text}),e},pt.marksFromSchema=function(t){return ut(t.marks)},e.Node=T,e.ResolvedPos=k,e.NodeRange=M,e.Fragment=i,e.Slice=p,e.ReplaceError=h,e.Mark=c,e.Schema=X,e.NodeType=J,e.MarkType=Y,e.ContentMatch=_,e.DOMParser=Z,e.DOMSerializer=pt})
rs(ls)
...
var U=[new H]
function q(t,e,n){if(0==t.length)return U
...
null!=c&&(n&&1==i.length&&i.push(a=r=new H(e.isInline?"span":"div")),"class"==l?a.class=(a.class?a.class+" ":"")+c:"style"==l?a.style=(a.style?a.style+";":"")+c:"nodeName"!=l&&(a[l]=c))}}return i}function J(t,e,n,r){if(n==U&&r==U)return e
...
n.style&&(t.style.cssText+=n.style)}}function K(t,e,n){return J(t,t,U,q(e,n,1!=t.nodeType))}function G(t,e){if(t.length!=e.length)return!1
...
return!!r&&(r(t,e)||e.defaultPrevented)})}function qt(t){return{left:t.clientX,top:t.clientY}}function Jt(t,e,n,r,i){if(-1==r)return!1
...
"pointer"==n&&r.setMeta("pointer",!0),t.dispatch(r)}function Kt(t,e,n,r,i){return Jt(t,"handleClickOn",e,n,r)||t.someProp("handleClick",function(n){return n(t,e,r)})||(i?function(t,e){if(-1==e)return!1
...
return!!(r&&r.isAtom&&ms.NodeSelection.isSelectable(r))&&(Wt(t,new ms.NodeSelection(n),"pointer"),!0)}(t,n))}function Gt(t,e,n,r){return Jt(t,"handleTripleClickOn",e,n,r)||t.someProp("handleTripleClick",function(n){return n(t,e,r)})||function(t,e){var n=t.state.doc
...
var s=t.posAtCoords(qt(e))
s&&("singleClick"==i?t.mouseDown=new Qt(t,s,e,n):("doubleClick"==i?function(t,e,n,r){return Jt(t,"handleDoubleClickOn",e,n,r)||t.someProp("handleDoubleClick",function(n){return n(t,e,r)})}:Gt)(t,s.pos,s.inside,e)?e.preventDefault():t.selectionReader.poll("pointer"))}
...
if(n&&n.done(),e.dataTransfer){var r=t.state.selection,i=r.empty?null:t.posAtCoords(qt(e))
...
if(t.dragging=null,e.dataTransfer){var r=t.posAtCoords(qt(e))
...
r.text&&""!==r.text&&(n.text=r.text),n.marks=n.marks.concat(r.marks)}}else if(0===t.children.length)this.xpath.stringValue(t,r.text)&&(n.content=[{type:"text",text:this.xpath.stringValue(t,r.text),marks:this.parseContentMarks(t,e.schema.marks)}])
else{let r=[]
...
i.values?i.values[r[1]]&&(s=i.values[r[1]]):s=i.value?i.value.replace("${value}",r[1]):r[1],void 0!==s&&("text()"===i.attr?n.text=s:n.attrs[i.attr]?n.attrs[i.attr].push(s):n.attrs[i.attr]=[s])}),e.schema.nodes[t.type].inline){if(t.content)if(t.content.length>1||t.content[0].marks&&t.content[0].marks.length>0)t.content.forEach(t=>{n.children.push(this.serializeTextNode(t,e))})
...
const no=new class extends Hr{constructor(){let t=new Wi(to),e=new Ji(eo,t)
...
J=(()=>{no.scheduleRerender()}),no.registerInitializer({initialize(t){t.register(`component-manager:/${no.rootName}/component-managers/main`,se)}}),no.renderComponent("TeiEditor",ro,null),no.boot(),function(t,e){for(let n in e)ae(t,n,e[n])}(no,{"tei-editor":"TeiEditor"})})
