    ...
    <nav class="flex-none">
        <ul class="flex">
            ...
            {:else if !$branchesBusy}
                <li role="presentation">
                    <Link to="/new" class="block px-3 py-1 border-b-2 border-solid border-gray-300 hover:border-blue-700 focus:border-blue-700 transition-colors" aria-label="New Task">
                        <svg viewBox="0 0 24 24" class="w-6 h-6">
