<script lang="ts">
    ...
    import { activeBranches, getAllBranches, branchesBusy } from '../stores';
...
<div class="w-full h-full flex flex-col">
    ...
    <nav class="flex-none">
        <ul class="flex">
            ...
            {#if $selectedTask}
                <li role="presentation">
                    <button class="block px-3 py-1 border-b-2 border-solid border-gray-300 hover:border-blue-700 focus:border-blue-700 transition-colors" aria-label="Request integration" title="Request integration">
                ...
                <li role="presentation">
                    <button class="block px-3 py-1 border-b-2 border-solid border-gray-300 hover:border-blue-700 focus:border-blue-700 transition-colors" aria-label="Update to the latest changes from the primary copy" title="Update to the latest changes from the primary copy">
                        <svg viewBox="0 0 24 24" class="w-6 h-6">
