  ...
  (0, _qunit.module)('Integration | Component | body-editor', function (hooks) {
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "1ClUe2jo",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"body-editor\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('client/tests/lint/templates.template.lint-test', [], function () {
  ...
  QUnit.test('client/templates/components/dropdown-menu-item.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'client/templates/components/dropdown-menu-item.hbs should pass TemplateLint.\n\nclient/templates/components/dropdown-menu-item.hbs\n  3:18  error  Incorrect indentation of attribute \'items\' beginning at L3:C18. Expected \'items\' to be at L4:C4.  attribute-indentation\n  3:35  error  Incorrect indentation of attribute \'is_nested\' beginning at L3:C35. Expected \'is_nested\' to be at L5:C4.  attribute-indentation\n  3:50  error  Incorrect indentation of attribute \'is_focus\' beginning at L3:C50. Expected \'is_focus\' to be at L6:C4.  attribute-indentation\n  3:68  error  Incorrect indentation of attribute \'onaction\' beginning at L3:C68. Expected \'onaction\' to be at L7:C4.  attribute-indentation\n  3:85  error  Incorrect indentation of close curly braces \'}}\' for the component \'{{dropdown-menu}}\' beginning at L3:C85. Expected \'{{dropdown-menu}}\' to be at L8:C2.  attribute-indentation\n');
  });
  ...
  QUnit.test('client/templates/components/node-editor.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'client/templates/components/node-editor.hbs should pass TemplateLint.\n\nclient/templates/components/node-editor.hbs\n  10:18  error  Incorrect indentation of htmlAttribute \'d\' beginning at L10:C18. Expected \'d\' to be at L11:C14.  attribute-indentation\n  10:230  error  Incorrect indentation of close bracket \'>\' for the element \'<path>\' beginning at L10:C230. Expected \'<path>\' to be at L12:C12.  attribute-indentation\n  20:21  error  Incorrect indentation of htmlAttribute \'type\' beginning at L20:C21. Expected \'type\' to be at L21:C16.  attribute-indentation\n  20:33  error  Incorrect indentation of htmlAttribute \'value\' beginning at L20:C33. Expected \'value\' to be at L22:C16.  attribute-indentation\n  20:49  error  Incorrect indentation of htmlAttribute \'onchange\' beginning at L20:C49. Expected \'onchange\' to be at L21:C16.  attribute-indentation\n  20:96  error  Incorrect indentation of close bracket \'>\' for the element \'<input>\' beginning at L20:C96. Expected \'<input>\' to be at L21:C14.  attribute-indentation\n  26:22  error  Incorrect indentation of htmlAttribute \'d\' beginning at L26:C22. Expected \'d\' to be at L27:C18.  attribute-indentation\n  26:207  error  Incorrect indentation of close bracket \'>\' for the element \'<path>\' beginning at L26:C207. Expected \'<path>\' to be at L28:C16.  attribute-indentation\n  41:17  error  Incorrect indentation of htmlAttribute \'type\' beginning at L41:C17. Expected \'type\' to be at L42:C12.  attribute-indentation\n  41:29  error  Incorrect indentation of htmlAttribute \'value\' beginning at L41:C29. Expected \'value\' to be at L43:C12.  attribute-indentation\n  41:49  error  Incorrect indentation of htmlAttribute \'onchange\' beginning at L41:C49. Expected \'onchange\' to be at L42:C12.  attribute-indentation\n  41:94  error  Incorrect indentation of close bracket \'>\' for the element \'<input>\' beginning at L41:C94. Expected \'<input>\' to be at L42:C10.  attribute-indentation\n  48:17  error  Incorrect indentation of htmlAttribute \'type\' beginning at L48:C17. Expected \'type\' to be at L49:C12.  attribute-indentation\n  48:29  error  Incorrect indentation of htmlAttribute \'value\' beginning at L48:C29. Expected \'value\' to be at L50:C12.  attribute-indentation\n  48:49  error  Incorrect indentation of htmlAttribute \'onchange\' beginning at L48:C49. Expected \'onchange\' to be at L49:C12.  attribute-indentation\n  48:94  error  Incorrect indentation of close bracket \'>\' for the element \'<input>\' beginning at L48:C94. Expected \'<input>\' to be at L49:C10.  attribute-indentation\n  7:10  error  Incorrect indentation for `Attributes\n        ` beginning at L7:C10. Expected `Attributes\n        ` to be at an indentation of 8 but was found at 10.  block-indentation\n  19:19  error  Incorrect indentation for `<span>` beginning at L19:C19. Expected `<span>` to be at an indentation of 14 but was found at 19.  block-indentation\n  40:15  error  Incorrect indentation for `Text\n          ` beginning at L40:C15. Expected `Text\n          ` to be at an indentation of 10 but was found at 15.  block-indentation\n  47:15  error  Incorrect indentation for `Tail\n          ` beginning at L47:C15. Expected `Tail\n          ` to be at an indentation of 10 but was found at 15.  block-indentation\n  20:14  error  Self-closing a void element is redundant  self-closing-void-elements\n  41:10  error  Self-closing a void element is redundant  self-closing-void-elements\n  48:10  error  Self-closing a void element is redundant  self-closing-void-elements\n');
  });
  ...
  QUnit.test('client/templates/components/tree-view.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'client/templates/components/tree-view.hbs should pass TemplateLint.\n\nclient/templates/components/tree-view.hbs\n  7:16  error  Incorrect indentation of htmlAttribute \'d\' beginning at L7:C16. Expected \'d\' to be at L8:C12.  attribute-indentation\n  7:228  error  Incorrect indentation of close bracket \'>\' for the element \'<path>\' beginning at L7:C228. Expected \'<path>\' to be at L9:C10.  attribute-indentation\n  12:16  error  Incorrect indentation of htmlAttribute \'d\' beginning at L12:C16. Expected \'d\' to be at L13:C12.  attribute-indentation\n  12:201  error  Incorrect indentation of close bracket \'>\' for the element \'<path>\' beginning at L12:C201. Expected \'<path>\' to be at L14:C10.  attribute-indentation\n  15:9  error  Incorrect indentation of htmlAttribute \'href\' beginning at L15:C9. Expected \'href\' to be at L16:C8.  attribute-indentation\n  15:18  error  Incorrect indentation of htmlAttribute \'title\' beginning at L15:C18. Expected \'title\' to be at L17:C8.  attribute-indentation\n  15:88  error  Incorrect indentation of close bracket \'>\' for the element \'<a>\' beginning at L15:C88. Expected \'<a>\' to be at L18:C6.  attribute-indentation\n  17:18  error  Incorrect indentation of htmlAttribute \'d\' beginning at L17:C18. Expected \'d\' to be at L18:C14.  attribute-indentation\n  17:198  error  Incorrect indentation of close bracket \'>\' for the element \'<path>\' beginning at L17:C198. Expected \'<path>\' to be at L19:C12.  attribute-indentation\n  20:9  error  Incorrect indentation of htmlAttribute \'href\' beginning at L20:C9. Expected \'href\' to be at L21:C8.  attribute-indentation\n  20:18  error  Incorrect indentation of htmlAttribute \'title\' beginning at L20:C18. Expected \'title\' to be at L22:C8.  attribute-indentation\n  20:90  error  Incorrect indentation of close bracket \'>\' for the element \'<a>\' beginning at L20:C90. Expected \'<a>\' to be at L23:C6.  attribute-indentation\n  22:18  error  Incorrect indentation of htmlAttribute \'d\' beginning at L22:C18. Expected \'d\' to be at L23:C14.  attribute-indentation\n  22:197  error  Incorrect indentation of close bracket \'>\' for the element \'<path>\' beginning at L22:C197. Expected \'<path>\' to be at L24:C12.  attribute-indentation\n  30:52  error  Incorrect indentation of attribute \'node\' beginning at L30:C52. Expected \'node\' to be at L31:C42.  attribute-indentation\n  30:63  error  Incorrect indentation of attribute \'parent\' beginning at L30:C63. Expected \'parent\' to be at L32:C42.  attribute-indentation\n  30:75  error  Incorrect indentation of attribute \'click-node-title\' beginning at L30:C75. Expected \'click-node-title\' to be at L33:C42.  attribute-indentation\n  30:109  error  Incorrect indentation of attribute \'add-child-node\' beginning at L30:C109. Expected \'add-child-node\' to be at L34:C42.  attribute-indentation\n  30:139  error  Incorrect indentation of attribute \'remove-node\' beginning at L30:C139. Expected \'remove-node\' to be at L35:C42.  attribute-indentation\n  30:163  error  Incorrect indentation of attribute \'move-node-forward\' beginning at L30:C163. Expected \'move-node-forward\' to be at L36:C42.  attribute-indentation\n  30:199  error  Incorrect indentation of attribute \'move-node-backward\' beginning at L30:C199. Expected \'move-node-backward\' to be at L37:C42.  attribute-indentation\n  30:236  error  Incorrect indentation of close curly braces \'}}\' for the component \'{{tree-view}}\' beginning at L30:C236. Expected \'{{tree-view}}\' to be at L38:C40.  attribute-indentation\n  17:12  error  Incorrect indentation for `<path>` beginning at L17:C12. Expected `<path>` to be at an indentation of 10 but was found at 12.  block-indentation\n  22:12  error  Incorrect indentation for `<path>` beginning at L22:C12. Expected `<path>` to be at an indentation of 10 but was found at 12.  block-indentation\n  29:26  error  elements cannot have inline styles  no-inline-styles\n');
  });

  QUnit.test('client/templates/components/xml-tree-editor.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'client/templates/components/xml-tree-editor.hbs should pass TemplateLint.\n\nclient/templates/components/xml-tree-editor.hbs\n  1:12  error  Incorrect indentation of attribute \'node\' beginning at L1:C12. Expected \'node\' to be at L2:C2.  attribute-indentation\n  1:22  error  Incorrect indentation of attribute \'parent\' beginning at L1:C22. Expected \'parent\' to be at L3:C2.  attribute-indentation\n  2:2  error  Incorrect indentation of attribute \'click-node-title\' beginning at L2:C2. Expected \'click-node-title\' to be at L4:C2.  attribute-indentation\n  3:2  error  Incorrect indentation of attribute \'add-child-node\' beginning at L3:C2. Expected \'add-child-node\' to be at L5:C2.  attribute-indentation\n  4:2  error  Incorrect indentation of attribute \'remove-node\' beginning at L4:C2. Expected \'remove-node\' to be at L6:C2.  attribute-indentation\n  5:2  error  Incorrect indentation of attribute \'move-node-forward\' beginning at L5:C2. Expected \'move-node-forward\' to be at L7:C2.  attribute-indentation\n  6:2  error  Incorrect indentation of attribute \'move-node-backward\' beginning at L6:C2. Expected \'move-node-backward\' to be at L8:C2.  attribute-indentation\n  6:50  error  Incorrect indentation of close curly braces \'}}\' for the component \'{{tree-view}}\' beginning at L6:C50. Expected \'{{tree-view}}\' to be at L9:C0.  attribute-indentation\n');
  });

  QUnit.test('client/templates/editor.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'client/templates/editor.hbs should pass TemplateLint.\n\nclient/templates/editor.hbs\n  10:22  error  Incorrect indentation of htmlAttribute \'d\' beginning at L10:C22. Expected \'d\' to be at L11:C18.  attribute-indentation\n  10:331  error  Incorrect indentation of close bracket \'>\' for the element \'<path>\' beginning at L10:C331. Expected \'<path>\' to be at L12:C16.  attribute-indentation\n  19:24  error  Incorrect indentation of htmlAttribute \'d\' beginning at L19:C24. Expected \'d\' to be at L20:C20.  attribute-indentation\n  19:255  error  Incorrect indentation of close bracket \'>\' for the element \'<path>\' beginning at L19:C255. Expected \'<path>\' to be at L21:C18.  attribute-indentation\n  27:24  error  Incorrect indentation of htmlAttribute \'d\' beginning at L27:C24. Expected \'d\' to be at L28:C20.  attribute-indentation\n  27:114  error  Incorrect indentation of close bracket \'>\' for the element \'<path>\' beginning at L27:C114. Expected \'<path>\' to be at L29:C18.  attribute-indentation\n  37:28  error  Incorrect indentation of htmlAttribute \'d\' beginning at L37:C28. Expected \'d\' to be at L38:C24.  attribute-indentation\n  37:183  error  Incorrect indentation of close bracket \'>\' for the element \'<path>\' beginning at L37:C183. Expected \'<path>\' to be at L39:C22.  attribute-indentation\n  44:28  error  Incorrect indentation of htmlAttribute \'d\' beginning at L44:C28. Expected \'d\' to be at L45:C24.  attribute-indentation\n  44:305  error  Incorrect indentation of close bracket \'>\' for the element \'<path>\' beginning at L44:C305. Expected \'<path>\' to be at L46:C22.  attribute-indentation\n  52:26  error  Incorrect indentation of htmlAttribute \'d\' beginning at L52:C26. Expected \'d\' to be at L53:C22.  attribute-indentation\n  52:181  error  Incorrect indentation of close bracket \'>\' for the element \'<path>\' beginning at L52:C181. Expected \'<path>\' to be at L54:C20.  attribute-indentation\n  59:26  error  Incorrect indentation of htmlAttribute \'d\' beginning at L59:C26. Expected \'d\' to be at L60:C22.  attribute-indentation\n  59:303  error  Incorrect indentation of close bracket \'>\' for the element \'<path>\' beginning at L59:C303. Expected \'<path>\' to be at L61:C20.  attribute-indentation\n  73:24  error  Incorrect indentation of htmlAttribute \'d\' beginning at L73:C24. Expected \'d\' to be at L74:C20.  attribute-indentation\n  73:166  error  Incorrect indentation of close bracket \'>\' for the element \'<path>\' beginning at L73:C166. Expected \'<path>\' to be at L75:C18.  attribute-indentation\n  80:24  error  Incorrect indentation of htmlAttribute \'d\' beginning at L80:C24. Expected \'d\' to be at L81:C20.  attribute-indentation\n  80:166  error  Incorrect indentation of close bracket \'>\' for the element \'<path>\' beginning at L80:C166. Expected \'<path>\' to be at L82:C18.  attribute-indentation\n  49:14  error  Incorrect indentation for `<li>` beginning at L49:C14. Expected `<li>` to be at an indentation of 16 but was found at 14.  block-indentation\n  56:14  error  Incorrect indentation for `<li>` beginning at L56:C14. Expected `<li>` to be at an indentation of 16 but was found at 14.  block-indentation\n  73:18  error  Incorrect indentation for `<path>` beginning at L73:C18. Expected `<path>` to be at an indentation of 16 but was found at 18.  block-indentation\n  80:18  error  Incorrect indentation for `<path>` beginning at L80:C18. Expected `<path>` to be at an indentation of 16 but was found at 18.  block-indentation\n  17:14  error  Do not use an <a> element with the `href` attribute inside an element with `role="menuitem"`  no-nested-interactive\n  35:18  error  Do not use an <a> element with the `href` attribute inside an element with `role="menuitem"`  no-nested-interactive\n  42:18  error  Do not use an <a> element with the `href` attribute inside an element with `role="menuitem"`  no-nested-interactive\n  71:12  error  Do not use an <a> element with the `href` attribute inside an element with `role="menuitem"`  no-nested-interactive\n  78:12  error  Do not use an <a> element with the `href` attribute inside an element with `role="menuitem"`  no-nested-interactive\n');
  });

  QUnit.test('client/templates/editor/file.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'client/templates/editor/file.hbs should pass TemplateLint.\n\nclient/templates/editor/file.hbs\n  8:44  error  Incorrect indentation of htmlAttribute \'href\' beginning at L8:C44. Expected \'href\' to be at L9:C43.  attribute-indentation\n  8:53  error  Incorrect indentation of htmlAttribute \'onclick\' beginning at L8:C53. Expected \'onclick\' to be at L10:C43.  attribute-indentation\n  8:108  error  Incorrect indentation of htmlAttribute \'aria-selected\' beginning at L8:C108. Expected \'aria-selected\' to be at L9:C43.  attribute-indentation\n  8:128  error  Incorrect indentation of close bracket \'>\' for the element \'<a>\' beginning at L8:C128. Expected \'<a>\' to be at L10:C41.  attribute-indentation\n  8:137  error  Incorrect indentation of close tag \'</a>\' for element \'<a>\' beginning at L8:C137. Expected \'</a>\' to be at L8:C41.  attribute-indentation\n  17:54  error  Incorrect indentation of attribute \'node\' beginning at L17:C54. Expected \'node\' to be at L18:C38.  attribute-indentation\n  17:72  error  Incorrect indentation of attribute \'click-node-title\' beginning at L17:C72. Expected \'click-node-title\' to be at L19:C38.  attribute-indentation\n  17:121  error  Incorrect indentation of attribute \'notify-model-change\' beginning at L17:C121. Expected \'notify-model-change\' to be at L20:C38.  attribute-indentation\n  17:171  error  Incorrect indentation of close curly braces \'}}\' for the component \'{{xml-tree-editor}}\' beginning at L17:C171. Expected \'{{xml-tree-editor}}\' to be at L21:C36.  attribute-indentation\n  21:30  error  Incorrect indentation of attribute \'node\' beginning at L21:C30. Expected \'node\' to be at L22:C18.  attribute-indentation\n  21:58  error  Incorrect indentation of attribute \'edit_tail\' beginning at L21:C58. Expected \'edit_tail\' to be at L23:C18.  attribute-indentation\n  21:74  error  Incorrect indentation of attribute \'notify-model-change\' beginning at L21:C74. Expected \'notify-model-change\' to be at L24:C18.  attribute-indentation\n  21:124  error  Incorrect indentation of close curly braces \'}}\' for the component \'{{node-editor}}\' beginning at L21:C124. Expected \'{{node-editor}}\' to be at L25:C16.  attribute-indentation\n');
  });

  QUnit.test('client/templates/editor/files.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'client/templates/editor/files.hbs should pass TemplateLint.\n\nclient/templates/editor/files.hbs\n  5:26  error  Do not use an <a> element with the `href` attribute inside an element with `role="menuitem"`  no-nested-interactive\n');
  });

  QUnit.test('client/templates/editor/repositories.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'client/templates/editor/repositories.hbs should pass TemplateLint.\n\nclient/templates/editor/repositories.hbs\n  5:26  error  Do not use an <a> element with the `href` attribute inside an element with `role="menuitem"`  no-nested-interactive\n');
  });
